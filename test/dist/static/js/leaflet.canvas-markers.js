!(function(t) {
  ...
  function(t, n, i) {
    ...
    function f(t, n) {
      return (
        (Math.max(n.maxX, t.maxX) - Math.min(n.minX, t.minX)) *
        (Math.max(n.maxY, t.maxY) - Math.min(n.minY, t.minY))
      )
    }
    function d(t, n) {
    ...
    e.prototype = {
      ...
      _build: function(t, n, i, a) {
        ...
        for (x(t, n, i, f, this.compareMinX), h = n; h <= i; h += f)
          for (
            x(t, h, (c = Math.min(h + f - 1, i)), m, this.compareMinY), l = h;
            l <= c;
            l += m
          )
            (u = Math.min(l + m - 1, c)),

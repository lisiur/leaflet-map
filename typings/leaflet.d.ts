...
// import * as leafletCanvasMarker from './leaflet-canvas-marker'

// export const heatLayer: leafletHeat.heatLayer
// export const canvasIconLayer: leafletCanvasMarker.canvasIconLayer

// export interface HeatLayer{}
// export const HeatLayerOptions: leafletHeat.HeatLayerOptions
...
export namespace tileLayer {
  ...
  function chinaProvider(baseUrl: string, options?: WMSOptions): TileLayer.WMS
}
